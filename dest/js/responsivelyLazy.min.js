...
var responsivelyLazy = "undefined" !== typeof responsivelyLazy ? responsivelyLazy : function() {
    var r = !1,
        ...
        w = function(a, b) {
            for (var c = a.length, d = b; d < c; d++) {
                ...
                null !== g &&
                    (e.setAttribute("src", g), ("undefined" === typeof f.async || !1 === f.async) && d + 1 < c && (h = !0, e.addEventListener("load", function() { w(a, d + 1) })));
        ...
        x = function(a, b) {
            ...
            if (null !== c)
                if (c = c.trim(), 0 < c.length) {
                    ...
                    d.sort(function(a, b) { if (a[1] < b[1]) return -1; if (a[1] > b[1]) return 1; if (a[1] === b[1]) { if (-1 !== b[0].indexOf(".webp", b[0].length - 5)) return 1; if (-1 !== a[0].indexOf(".webp", a[0].length - 5)) return -1 } return 0 });
                    c = d
                } else c = [];
            else c = [];
            ...
            a.responsivelyLazyLastSetOption[1] < d[1] && (a.responsivelyLazyLastSetOption = d, h = d[0], "undefined" === typeof a.responsivelyLazyEventsAttached && (a.responsivelyLazyEventsAttached = !0, b.addEventListener("load", function() {
                ...
                }, !1), b.addEventListener("error", function() { a.responsivelyLazyLastSetOption = ["", 0] }, !1)), h === b.getAttribute("src") ?
        ...
        z = function() { for (var a = document.querySelectorAll(".responsively-lazy"), b = a.length, c = 0; c < b; c++) y(a[c]) };
    if ("undefined" !== typeof window.addEventListener && "undefined" !== typeof document.querySelectorAll) {
        ...
        n.onload = n.onerror = function() {
            ...
            var a = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(a) { window.setTimeout(a, 1E3 / 60) },
                b = !0,
                c = function() {
                    b && (b = !1, z());
                    a.call(null, c)
            ...
            if (m) {
                var d = function() {
                    for (var a = document.querySelectorAll(".responsively-lazy"),
                            b = a.length, c = 0; c < b; c++) { var e = a[c]; "undefined" === typeof e.responsivelyLazyObserverAttached && (e.responsivelyLazyObserverAttached = !0, h.observe(e)) }
                };
            ...
            var e = function() { m ? (window.clearTimeout(f), f = window.setTimeout(function() { b = !0 }, 300)) : b = !0 },
                g = function() {
                ...
                k = function() {
                    ...
                    m && d();
                    g();
                    "undefined" !== typeof MutationObserver && (new MutationObserver(function() { q || (m && d(), g(), e()) })).observe(document.querySelector("body"), { childList: !0, subtree: !0 })
                };
            "loading" === document.readyState ?
                document.addEventListener("DOMContentLoaded", k) : k()
        }
    }
    return { run: z, isVisible: v }
}();